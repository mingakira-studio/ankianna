...
12. [>] UI优化 P1: 设计系统基础 — DesignTokens.swift(颜色/字号/间距/圆角)、SF Rounded字体、emoji吉祥物替换、游戏模式视觉统一 (SwiftUI Expert) ← NEXT
13. [ ] UI优化 P2: 交互体验 — 游戏结束返回首页、过渡动画、颜色辅助指示、学习tab badge、答对显示对应字 (ui-ux-pro-max + SwiftUI Expert)
...
## NEXT: UI优化 P1 — 设计系统基础
> 审查报告: docs/plans/2026-03-12-ui-ux-review.md (P1 章节)
