...
final class MatchViewModelTests: XCTestCase {
    func testGridSizeIs12For6Pairs() {
        ...
        vm.setup(characters: [
            (char: "大", word: "大人", speakText: "大人"),
            (char: "小", word: "小鸟", speakText: "小鸟"),
            (char: "水", word: "水果", speakText: "水果"),
            (char: "火", word: "火车", speakText: "火车"),
            (char: "山", word: "山上", speakText: "山上"),
            (char: "花", word: "花朵", speakText: "花朵")
        ])
    ...
    func testGameCompleteWhenAllMatched() {
        ...
        vm.setup(characters: [(char: "大", word: "大人", speakText: "大人")])
